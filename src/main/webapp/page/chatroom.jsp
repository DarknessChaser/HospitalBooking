...
<body>
    ...
    <div class="title">
        <div class="am-g am-g-fixed">
            <div class="am-u-sm-12">
				<h1 class="am-text-primary">在线咨询室</h1>
            </div>
        </div>
    </div>
    <!-- title end -->
    ...
    <div class="message-input am-margin-top">
        ...
        <div class="am-g am-g-fixed am-margin-top">
            <div class="am-u-sm-5">
                <button id="back" type="button" class="am-btn am-btn-secondary am-fr">
                    <i class="am-icon-arrow-circle-left"></i> 返回
                </button>
                <div id="message-input-nickname" class="am-input-group am-input-group-primary am-hide">
                    <span class="am-input-group-label"><i class="am-icon-user"></i></span>
                    <input id="nickname" type="text" class="am-form-field" placeholder="请输入用户昵称" value="${chatname}"/>
                </div>
            </div>
            <div class="am-u-sm-2"></div>
            <div class="am-u-sm-5">
                <button id="send" type="button" class="am-btn am-btn-primary am-fl">
